...
SRCS_TRIGGER = $(SRC_DIR)/Trigger_SFs.cpp
...
TRIGGERTARGET = $(BIN_DIR)/Trigger_SFs.x
...
# --- Default target ---
all: $(CMSSWTARGET) $(CONDORTARGET) $(MERGETARGET) $(FLATTENTARGET) $(PLOTTERTARGET) $(TRIGGERTARGET) $(PLOTTERYIELDSTARGET) $(PLOTTERFDSTARGET) $(PLOTTERSIGSTARGET) $(CONVERTGAUSSTOGAMMATARGET) $(MAKESAMPLETABLESTARGET) $(PYBIND_TARGET) # $(TARGET)
