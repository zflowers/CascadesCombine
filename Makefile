...
# --- Default target ---
all: $(CMSSWTARGET) $(CONDORTARGET) $(MERGETARGET) $(FLATTENTARGET) $(PLOTTERTARGET) $(PLOTTERYIELDSTARGET) $(PLOTTERFDSTARGET) $(PLOTTERSIGSTARGET) $(CONVERTGAUSSTOGAMMATARGET) $(PYBIND_TARGET) # $(TARGET)
