...
# --- Default target ---
all: $(CMSSWTARGET) $(CONDORTARGET) $(MERGETARGET) $(FLATTENTARGET) $(PLOTTERTARGET) $(PLOTTERYIELDSTARGET) $(PLOTTERFDSTARGET) $(PLOTTERSIGSTARGET) $(CONVERTGAUSSTOGAMMATARGET) $(MAKESAMPLETABLESTARGET) $(PYBIND_TARGET) # $(TARGET)
