...
SRCS_SMSMASSMAP = $(SRC_DIR)/PlotSMSMassMap.cpp
...
SMSMASSMAPTARGET = $(BIN_DIR)/PlotSMSMassMap.x

# --- Default target ---
all: $(CMSSWTARGET) $(CONDORTARGET) $(MERGETARGET) $(FLATTENTARGET) $(PLOTTERTARGET) $(TRIGGERSFTARGET) $(TRIGGERTARGET) $(PLOTTERYIELDSTARGET) $(PLOTTERFDSTARGET) $(PLOTTERSIGSTARGET) $(CONVERTGAUSSTOGAMMATARGET) $(MAKESAMPLETABLESTARGET) $(SMSMASSMAPTARGET) $(PYBIND_TARGET) # $(TARGET)
...
$(SMSMASSMAPTARGET): $(OBJS_DIR) $(OBJS_DIR)/PlotSMSMassMap.o
	$(CXX) $(OBJS_DIR)/PlotSMSMassMap.o -o $@ $(LDFLAGS) $(ROOTCFLAGS)
